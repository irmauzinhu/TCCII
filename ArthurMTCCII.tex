...
Na tabela abaixo é disposto um pequeno exemplo de como seria uma matriz encontrada em sistemas que utilizão a recomendação não personalizada, onde seus produtos são avaliados de forma individual por seus usuários.
